...
namespace Janus {
  ...
  class Subscriber : public JanusPlugin {
   public:
  ...
  class SubscriberFactory : public PluginFactory {
   public:
     JanusPluginInfo info() {
       return JanusPluginInfo("janus.plugin.videoroom.subscriber", "Videoroom subscriber pseudo-plugin", 0);
     }
